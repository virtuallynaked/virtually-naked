...
public static class InitialSettings {
	...
	public static readonly Dictionary<string, string> MaterialSets = new Dictionary<string, string> {
		...
		["breakfast-in-bed-tank"] = "Shadow Rose",
		["breakfast-in-bed-shorts"] = "Shadow Rose",
		...
		["bandeau-bikini-top"] = "Floral",
		["bandeau-bikini-bottoms"] = "Floral",
		["relaxed-sunday-tank"] = "Wings",
		["relaxed-sunday-shorts"] = "Wings",
		["relaxed-sunday-shoes"] = "Wings",
		["summer-dress-dress"] = "Red",
		["summer-dress-shoes"] = "Red",
		["upscale-shopper-blazer"] = "Grey",
		["upscale-shopper-blouse"] = "White Stripes",
		["upscale-shopper-pants"] = "Red",
		["upscale-shopper-heels"] = "Light",
